...
import co.thiagocc.netflixremake.util.DownloadImageTask
import co.thiagocc.netflixremake.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=141c1d8f-e891-4320-82b5-32210221c8a9"
    ...
    override fun onResult(movieDetail: MovieDetail) {
        ...
        txtDesc.text = movieDetail.movie.des
